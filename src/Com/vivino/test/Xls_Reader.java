...
XSSFCell cell=row.getCell(1);
    ...
    // returns the data from a cell (this function return the data of cell which we want )
    public String getCellData(String sheetName,String colName,int rowNum){
        try{
            ...
            if(cell==null)
                return "";
            //System.out.println(cell.getCellType()); below line make all cell type as string.
